    ...
    <>
      ...
      <div className='flex gap-6'>
        ...
        <div className='w-full'>
          <div class="border h-100 rounded-md mt-5 dark:!bg-navy-800 shadow-shadow-500 shadow-3xl rounded-primary relative mx-auto flex w-full max-w-[550px] flex-col items-center bg-white bg-cover bg-clip-border p-[16px] dark:text-white dark:shadow-none">
